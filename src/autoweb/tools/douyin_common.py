        ...
        try:
            ...
            if active_element:
                ...
                comment_input = active_element.find_element(
                    By.CSS_SELECTOR, ".GXmFLge7.comment-input-inner-container"
                )
            ...
            try:
                send_button = container.find_element(
                    By.CSS_SELECTOR, '[data-e2e="comment-post"]'
                )
    ...
    def reply_to_comment_sync(
        ...
        try:
            ...
            try:
                ...
                if debug_log_func:
                    debug_log_func(
                        "info", f"成功回复评论: {reply_text[:20]}...", browser_number
                    )
                else:
